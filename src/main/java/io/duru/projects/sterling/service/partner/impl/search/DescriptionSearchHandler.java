 ...
 */
@Component
public class DescriptionSearchHandler implements SearchTypeHandler {
    ...
    public List<Partner> searchForList(String key) {
        return partnerRepository.findByDescriptionContaining(key);
    }

    @Override
    public SearchResultGroup.Type supportedType() {
        return SearchResultGroup.Type.DESCRIPTION;
    }
